...
namespace FTPbox.Forms
{
    public partial class Translate : Form
    {
        ...
        private void LoadData()
        {
            ...
            data.Rows[50].Cells[2].Value = "/main_form/configure";
            data.Rows[51].Cells[2].Value = "/main_form/file_filters";
            data.Rows[52].Cells[2].Value = "/main_form/ignored_extensions";
            data.Rows[53].Cells[2].Value = "/main_form/remove";
            data.Rows[54].Cells[2].Value = "/main_form/also_ignore";
            data.Rows[55].Cells[2].Value = "/main_form/dotfiles";
            data.Rows[56].Cells[2].Value = "/main_form/temp_files";
            data.Rows[57].Cells[2].Value = "/main_form/old_files";
            data.Rows[58].Cells[2].Value = "/main_form/enable_logging";
            data.Rows[59].Cells[2].Value = "/main_form/view_log";
            data.Rows[60].Cells[2].Value = "/new_account/new_ftp";
            data.Rows[61].Cells[2].Value = "/new_account/login_details";
            data.Rows[62].Cells[2].Value = "/new_account/encryption";
            data.Rows[63].Cells[2].Value = "/new_account/ask_for_password";
            data.Rows[64].Cells[2].Value = "/new_account/add";
            data.Rows[65].Cells[2].Value = "/new_account/done";
            data.Rows[66].Cells[2].Value = "/paths/new_paths";
            data.Rows[67].Cells[2].Value = "/paths/add_dir";
            data.Rows[68].Cells[2].Value = "/paths/select_dir";
            data.Rows[69].Cells[2].Value = "/paths/full_path";
            data.Rows[70].Cells[2].Value = "/paths/default_local";
            data.Rows[71].Cells[2].Value = "/paths/custom_local";
            data.Rows[72].Cells[2].Value = "/paths/local_folder";
            data.Rows[73].Cells[2].Value = "/paths/browse";
            data.Rows[74].Cells[2].Value = "/setup/authentication";
            data.Rows[75].Cells[2].Value = "/setup/sync_all_files";
            data.Rows[76].Cells[2].Value = "/setup/sync_specific_files";
            data.Rows[77].Cells[2].Value = "/setup/previous";
            data.Rows[78].Cells[2].Value = "/setup/next";
            data.Rows[79].Cells[2].Value = "/new_version/new_ver";
            data.Rows[80].Cells[2].Value = "/new_version/update_available";
            data.Rows[81].Cells[2].Value = "/new_version/new_v_available";
            data.Rows[82].Cells[2].Value = "/new_version/new_version";
            data.Rows[83].Cells[2].Value = "/new_version/current_version";
            data.Rows[84].Cells[2].Value = "/new_version/wanna_download";
            data.Rows[85].Cells[2].Value = "/new_version/download";
            data.Rows[86].Cells[2].Value = "/new_version/learn_more";
            data.Rows[87].Cells[2].Value = "/new_version/remind_me_next_time";
            data.Rows[88].Cells[2].Value = "/tray/tray_and_nots";
            data.Rows[89].Cells[2].Value = "/tray/updated";
            data.Rows[90].Cells[2].Value = "/tray/created";
            data.Rows[91].Cells[2].Value = "/tray/renamed";
            data.Rows[92].Cells[2].Value = "/tray/deleted";
            data.Rows[93].Cells[2].Value = "/tray/changed";
            data.Rows[94].Cells[2].Value = "/tray/FilesOrFoldersUpdated";
            data.Rows[95].Cells[2].Value = "/tray/FilesOrFoldersCreated";
            data.Rows[96].Cells[2].Value = "/tray/FilesAndFoldersChanged";
            data.Rows[97].Cells[2].Value = "/tray/ItemsDeleted";
            data.Rows[98].Cells[2].Value = "/tray/file";
            data.Rows[99].Cells[2].Value = "/tray/files";
            data.Rows[100].Cells[2].Value = "/tray/folder";
            data.Rows[101].Cells[2].Value = "/tray/folders";
            data.Rows[102].Cells[2].Value = "/tray/connecting";
            data.Rows[103].Cells[2].Value = "/tray/reconnecting";
            data.Rows[104].Cells[2].Value = "/tray/listing";
            data.Rows[105].Cells[2].Value = "/tray/uploading";
            data.Rows[106].Cells[2].Value = "/tray/downloading";
            data.Rows[107].Cells[2].Value = "/tray/ready";
            data.Rows[108].Cells[2].Value = "/tray/synced";
            data.Rows[109].Cells[2].Value = "/tray/syncing";
            data.Rows[110].Cells[2].Value = "/tray/offline";
            data.Rows[111].Cells[2].Value = "/tray/link_copied";
            data.Rows[112].Cells[2].Value = "/tray/recent_files";
            data.Rows[113].Cells[2].Value = "/tray/not_available";
            data.Rows[114].Cells[2].Value = "/tray/start_syncing";
            data.Rows[115].Cells[2].Value = "/tray/exit";
            data.Rows[116].Cells[2].Value = "/web_interface/web_int";
            data.Rows[117].Cells[2].Value = "/web_interface/downloading";
            data.Rows[118].Cells[2].Value = "/web_interface/in_a_minute";
            data.Rows[119].Cells[2].Value = "/web_interface/removing";
            data.Rows[120].Cells[2].Value = "/web_interface/removed";
            data.Rows[121].Cells[2].Value = "/web_interface/updating";
            data.Rows[122].Cells[2].Value = "/web_interface/updated";
            data.Rows[123].Cells[2].Value = "/web_interface/setup";
            data.Rows[124].Cells[2].Value = "/web_interface/use_webint";
            data.Rows[125].Cells[2].Value = "/web_interface/view";
