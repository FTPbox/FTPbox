...
namespace FTPbox.Forms
{
    public partial class Translate : Form
    {
        ...
        private void LoadData()
        {
            ...
            data.Rows[73].Cells[2].Value = "/setup/sync_all_files";
            data.Rows[74].Cells[2].Value = "/setup/sync_specific_files";
            data.Rows[75].Cells[2].Value = "/setup/previous";
            data.Rows[76].Cells[2].Value = "/setup/next";
            data.Rows[77].Cells[2].Value = "/new_version/new_ver";
            data.Rows[78].Cells[2].Value = "/new_version/update_available";
            data.Rows[79].Cells[2].Value = "/new_version/new_v_available";
            data.Rows[80].Cells[2].Value = "/new_version/new_version";
            data.Rows[81].Cells[2].Value = "/new_version/current_version";
            data.Rows[82].Cells[2].Value = "/new_version/wanna_download";
            data.Rows[83].Cells[2].Value = "/new_version/download";
            data.Rows[84].Cells[2].Value = "/new_version/learn_more";
            data.Rows[85].Cells[2].Value = "/new_version/remind_me_next_time";
            data.Rows[86].Cells[2].Value = "/tray/tray_and_nots";
            data.Rows[87].Cells[2].Value = "/tray/updated";
            data.Rows[88].Cells[2].Value = "/tray/created";
            data.Rows[89].Cells[2].Value = "/tray/renamed";
            data.Rows[90].Cells[2].Value = "/tray/deleted";
            data.Rows[91].Cells[2].Value = "/tray/changed";
            data.Rows[92].Cells[2].Value = "/tray/FilesOrFoldersUpdated";
            data.Rows[93].Cells[2].Value = "/tray/FilesOrFoldersCreated";
            data.Rows[94].Cells[2].Value = "/tray/FilesAndFoldersChanged";
            data.Rows[95].Cells[2].Value = "/tray/ItemsDeleted";
            data.Rows[96].Cells[2].Value = "/tray/file";
            data.Rows[97].Cells[2].Value = "/tray/files";
            data.Rows[98].Cells[2].Value = "/tray/folder";
            data.Rows[99].Cells[2].Value = "/tray/folders";
            data.Rows[100].Cells[2].Value = "/tray/connecting";
            data.Rows[101].Cells[2].Value = "/tray/reconnecting";
            data.Rows[102].Cells[2].Value = "/tray/listing";
            data.Rows[103].Cells[2].Value = "/tray/uploading";
            data.Rows[104].Cells[2].Value = "/tray/downloading";
            data.Rows[105].Cells[2].Value = "/tray/ready";
            data.Rows[106].Cells[2].Value = "/tray/synced";
            data.Rows[107].Cells[2].Value = "/tray/syncing";
            data.Rows[108].Cells[2].Value = "/tray/offline";
            data.Rows[109].Cells[2].Value = "/tray/link_copied";
            data.Rows[110].Cells[2].Value = "/tray/recent_files";
            data.Rows[111].Cells[2].Value = "/tray/not_available";
            data.Rows[112].Cells[2].Value = "/tray/start_syncing";
            data.Rows[113].Cells[2].Value = "/tray/exit";
            data.Rows[114].Cells[2].Value = "/web_interface/web_int";
            data.Rows[115].Cells[2].Value = "/web_interface/downloading";
            data.Rows[116].Cells[2].Value = "/web_interface/in_a_minute";
            data.Rows[117].Cells[2].Value = "/web_interface/removing";
            data.Rows[118].Cells[2].Value = "/web_interface/removed";
            data.Rows[119].Cells[2].Value = "/web_interface/updating";
            data.Rows[120].Cells[2].Value = "/web_interface/updated";
            data.Rows[121].Cells[2].Value = "/web_interface/setup";
            data.Rows[122].Cells[2].Value = "/web_interface/use_webint";
            data.Rows[123].Cells[2].Value = "/web_interface/view";
